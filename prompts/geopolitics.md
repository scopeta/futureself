...
- **Infrastructure & Safety:** Transportation safety, natural disaster resilience, urban planning quality, access to clean water and sanitation.
...
```json
{
  "domain": "geopolitics",
  "confidence": 0.70,
  "advice": "The user's current city (Delhi) has annual average PM2.5 levels of ~100 µg/m³, which is 20x the WHO guideline. Chronic exposure at this level is associated with a 2–3 year reduction in life expectancy. Given the user's respiratory sensitivity (noted in blueprint), this is a significant longevity risk. Options: 1) Invest in high-quality indoor air filtration (HEPA + activated carbon) for immediate mitigation, 2) Consider relocation to a city with PM2.5 < 15 µg/m³ if career flexibility allows, 3) If staying, schedule annual pulmonary function tests.",
  "risk_level": "high",
  "urgency": "high"
}
```
